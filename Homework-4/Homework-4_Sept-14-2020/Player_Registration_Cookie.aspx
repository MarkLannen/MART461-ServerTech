...
<body>
    <div class="container">
        <div class="mt-5 mb-4">
            <asp:Label ID="lblPlayerWelcome" runat="server" Text="" CssClass="text-white"></asp:Label>
        </div>
     </div>
    ...
    <div class="container">
        <form id="form1" runat="server">
            ...
            <asp:Button ID="btnGetCookie" runat="server" Text="Get Cookie" OnClick="btnGet_Click" CssClass="form-control" />
