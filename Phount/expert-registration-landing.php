                ...
                <form id="expertRegistrationForm" class="">
                    ...
                    <div class="row ">
                        <div class="form-group col-md-6">
                            <label id="lblExpertFirstName" class="text-white" for="txtExpertFirstName">First
                                Name</label>
                            <input type="text" id="txtExpertFirstName" class="form-control registration-element"
                                aria-describedby="firstNameHelp" placeholder="Enter First Name"></input>
                            <small id="firstNameHelp" class="form-text text-muted"></small>
                        </div>
                        <div class="form-group col-md-6">
                            <label id="lblExpertLastName" class="text-white" for="txtExpertLastName">Last Name</label>
                            <input type="text" id="txtExpertLastName" class="form-control registration-element"
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="txtExpertEmail" class="form-control registration-element"
                                aria-describedby="emailHelp" placeholder="Enter Email"></input>
                            <small id="emailHelp" class="form-text text-muted"></small>
                        </div>
                        <div class="form-group col-md-6">
                            <label id="lblExpertPhoneNumber" class="text-white" for="txtExpertPhoneNumber">Phone
                                Number</label>
                            <input type="text" id="txtExpertPhoneNumber" class="form-control registration-element"
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="txtExpertUserName" class="form-control registration-element"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="txtExpertPassword" class="form-control registration-element"
