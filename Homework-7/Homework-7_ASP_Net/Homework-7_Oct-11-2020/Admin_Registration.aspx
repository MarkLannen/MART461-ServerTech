<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Registration.aspx.cs" Inherits="Homework_7_Oct_11_2020.Admin_Registration" %>
    ...
    <div class="container text-white">
        <form id="form1" runat="server">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <asp:Label ID="Label13" runat="server" Text="" AssociatedControlId="txtCity">State</asp:Label>
